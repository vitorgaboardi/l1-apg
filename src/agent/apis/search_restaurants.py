...
def search_restaurants(city: str, radius: int = 5000, categories: list = [], conditions: list = [], name: str = "", limit: int = 10) -> dict:
    """Searches for restaurants given a city, radius, categories, conditions, and name.
    Args:
        - city (str): The name of the city to search for restaurants in.
        - radius (int): The radius (in meters) to search for restaurants around the city center. Default is 5000 meters.
        - categories (str): The categories of restaurants to search for. Default is "catering".
        - conditions (str): Additional conditions to filter the search results. Default is an empty string.
        - name (str): The name of the restaurant to search for. Default is an empty string.
        - limit (int): The maximum number of results to return. Default is 10 and maximum is 20.

    Returns:
        dict: A dictionary containing the search results, including restaurant names, addresses, and other relevant information.
    """
    ...
    if categories == []:
        categories = "categories=catering"
    else:
        categories = [f"catering.{category_name}," for category_name in categories]
...
if __name__ == "__main__":
    city_name = "Natal"
    search_results = search_restaurants(city_name, radius=10000, categories=["restaurant"], conditions=[], name="")
